...
dir_train = '/kaggle/input/vehicle-sorter-v2/modeldata/train'
dir_val = '/kaggle/input/vehicle-sorter-v2/modeldata/valid'
...
callback = tf.keras.callbacks.ModelCheckpoint('/kaggle/working/model.hdf5', save_best_only=True, monitor='val_accuracy',
                                              verbose=1, mode='auto')
